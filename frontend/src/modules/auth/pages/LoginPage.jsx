...
import { 
  ...
  FiArrowRight, FiShield, FiUser, FiArrowLeft 
} from 'react-icons/fi';
...
export default function LoginPage() {
  ...
  const [email, setEmail] = useState('hai@mintforge.io');
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    setIsLoading(true);
    const role = email.toLowerCase().includes('admin') ? 'ADMIN' : 'CREATOR';
    ...
    <div className="min-h-screen bg-[#090d16] text-slate-100 flex flex-col justify-between relative overflow-hidden">
      ...
      <main className="flex-1 flex items-center justify-center px-4 py-8 z-10">
        <div className="w-full max-w-md glass-panel rounded-3xl p-8 border border-slate-800 shadow-2xl relative">
          ...
          <div className="mb-6 p-3 rounded-2xl bg-slate-900/60 border border-slate-800/80 space-y-2">
            ...
            <div className="grid grid-cols-2 gap-2">
              <button
                ...
                className="px-2.5 py-2 rounded-xl bg-orange-500/10 hover:bg-orange-500/20 border border-orange-500/30 text-orange-400 text-xs font-semibold flex items-center justify-center gap-1.5 transition-colors"
              >
              ...
              <button
                ...
                className="px-2.5 py-2 rounded-xl bg-indigo-500/10 hover:bg-indigo-500/20 border border-indigo-500/30 text-indigo-400 text-xs font-semibold flex items-center justify-center gap-1.5 transition-colors"
              >
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <div className="flex items-center justify-between mb-1.5">
                ...
                <a href="#forgot" className="text-[11px] text-orange-400 hover:text-orange-300 transition-colors">
          ...
          <div className="mt-6 text-center text-xs text-slate-400">
            ...
            <Link
              ...
              className="font-bold text-orange-400 hover:text-orange-300 transition-colors ml-1"
            >
